<?php
     ...
     function subir_image(){
        if (isset($_FILES["image"])) {
            ...
            $stmt = $conexion->prepare("SELECT COUNT(id_exp) FROM exp_general_c;");
            $stmt->execute();
    ...
    function obtener_nombre_imagen($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image"];
    ...
    function obtener_nombre_imagen2($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image2 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image2"];
    ...
    function obtener_nombre_imagen3($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image3 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image3"];
    ...
    function obtener_nombre_imagen4($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image4 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image4"];
    ...
    function obtener_nombre_imagen5($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image5 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image5"];
    ...
    function obtener_nombre_imagen6($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image6 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image6"];
    ...
    function obtener_nombre_imagen7($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image7 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image7"];
    ...
    function obtener_nombre_imagen8($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image8 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){
            return $fila["image8"];
    ...
    function obtener_nombre_imagen9($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image9 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image9"];
    ...
    function obtener_nombre_imagen10($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image10 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image10"];
    ...
    function obtener_nombre_imagen11($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image11 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image11"];
    ...
    function obtener_nombre_imagen12($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image12 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image12"];
    ...
    function obtener_nombre_imagen13($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image13 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image13"];
    ...
    function obtener_nombre_imagen14($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image14 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image14"];
    ...
    function obtener_nombre_imagen15($id_exp){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT image15 FROM exp_general_c WHERE id_exp = '$id_exp'");
        $stmt->execute();
        $resultado = $stmt->fetchAll();
        foreach($resultado as $fila){ 
            return $fila["image15"];
    ...
    function obtener_todos_registros(){
        include('conexion.php');
        $stmt = $conexion->prepare("SELECT * FROM exp_general_c");
        $stmt->execute();
        $resultado = $stmt->fetchAll(); 
    ...
    function editar_image(){
        if (isset($_FILES["image"])) {
            ...
            $stmt = $conexion->prepare("SELECT COUNT(*) AS conteo FROM exp_general_c WHERE id_exp <= $id");
            $stmt->execute();
            $resultado = $stmt->fetchAll();
            foreach($resultado as $fila){
                $data = $fila["conteo"];
