                ...
                <main>
                    ...
                    <h1 class="mt-4">Eliminar Usuario</h1>
                        ...
                        <ol class="breadcrumb mb-2 ">
                            <li class="breadcrumb-item active">Poncelet / Eliminar Usuario</li> 
                        </ol>
                       ...
                       <div class="alert alert-danger" role="alert">
                            <h4 class="alert-heading">Esta seguro de dar de BAJA este Usuario ? </h4>
                            <p>Nombre: <?php echo $nombre?></p>
                            <p>Usuario: <?php echo $usuario?></p>
                            <p>Rol: <?php echo $rol?></p>
                                <form action="" method="POST">
                                    <input type="hidden" name="idusuario" value="<?php echo $idusuario?>">
                                    <a href="lista_usuarios.php" class="btn btn-outline-danger">Cancelar</a>
                                    <input type="submit" value="Aceptar" class="btn btn-danger">
                                </form>
                            <hr>
                            <p class="mb-0">Al dar en aceptar se dara de baja el usuario manteniendo su registro en la Base de datos</p>
                        </div>
