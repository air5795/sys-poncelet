<?php
    ...
    $query = mysqli_query($conexion, "SELECT * FROM ingresos_constructora");
    ...
    if ($result > 0) {
        ...
        $sql_tfila = mysqli_query($conexion, "SELECT COUNT(id_ingresosC) FROM ingresos_constructora;");
    ...
    if (!empty($_POST)) {
       ...
       else 
     {
            ...
            $num = $total2 +1;
             ...
             if ($nombre_image != '') {
                 $destino = 'img/cajaChica_constructora/';
                 ...
                 $src= $destino.$imgActa;
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO ingresos_constructora(
                        proyecto,
                        origen,
                        montoBs,
                        montoU,
            ...
            if ($query_insert) {
                ...
                header("Location: ingresos_constructora.php");
...
<html lang="en">
    ...
    <?php  include "includes/header.php";?>
        ...
        <div id="layoutSidenav_content">
                ...
                <h1 class="mt-4 col"><i class="fa-solid fa-cash-register"></i>  <strong>Registro  <span> CAJA CHICA PONCELET </strong>  <span style="color:#9fd591;"> Ingresos  
                <i class="fa-solid fa-square-caret-up"></i></span></h1>
                       ...
                       <!-- contenido del sistema 2--> 
                        ...
                        <form action="ingresos_constructora.php" method="post" class="fields was-validated " enctype="multipart/form-data" novalidate >
                            ...
                            <div class="col-md-6">
                                ...
                                <span for="inputFirstName">CAJA CHICA</span> 
                                    <select style="width: 100%;font-size:12px ;" name="proyecto" id="select" class="form-control  select" required >
                                        ...
                                        <?php
                                            $query = mysqli_query($conexion, "SELECT * from proyectos_constructora ORDER BY pro_nombre ASC;");
                                            $result = mysqli_num_rows($query);
                                            if ($result > 0) {
                                            while ($data = mysqli_fetch_array($query)) {
                                    ...
                                    if ($result > 0) {
                                        while ($data = mysqli_fetch_array($query)) {
                                            if ($data['respaldo'] != 'nodisponible.png' ) {
                                                $image = 'img/cajaChica_constructora/'.$data['respaldo'];
                            ...
                            <div class="modal fade " id="exampleModali<?php echo $data['id_ingresosC']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content  bg-opacity-80">
                                            <form action="eliminar_ingresos_constructora.php" method="post">
