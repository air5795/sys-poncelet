<?php
    ...
    $query = mysqli_query($conexion, "SELECT * FROM proyectos_constructora");
    ...
    if ($result > 0) {
        ...
        $sql_tfila = mysqli_query($conexion, "SELECT COUNT(id_proyecto) FROM proyectos_constructora;");
    ...
    if (!empty($_POST)) {
            ...
            $num = $total2 +1;
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO proyectos_constructora(pro_nombre,color)
...
<html lang="en">
    ...
    <?php  include "includes/header.php";?>
        ...
        <div id="layoutSidenav_content">
                ...
                <h1 class="mt-4 col"><i class="fa-solid fa-sack-dollar"></i> <strong>Gestor de <span> CAJA CHICA CONSTRUCTORA PONCELET </strong>   </span></h1>
                       ...
                       <!-- contenido del sistema 2--> 
                        ...
                        <form action="proyectos_constructora.php" method="post" class="fields was-validated " enctype="multipart/form-data" novalidate >
                        ...
                        <?php
                            $sql_suma_bs = mysqli_query($conexion, "SELECT SUM(g_montoBs) FROM gastos_constructora;");
                            $result_sum = mysqli_fetch_array($sql_suma_bs);
                            $total = $result_sum['SUM(g_montoBs)']; 

                            $sql_suma_bs2 = mysqli_query($conexion, "SELECT SUM(montoBs) FROM ingresos_constructora;");
                        ...
                        <div class="col">
                            ...
                            <tr style="background-color:<?php echo $data['color'];?> ;">
                                ...
                                <td ><?php
                                    ...
                                    $s = mysqli_query($conexion, "SELECT SUM(montoBs) FROM ingresos_constructora WHERE proyecto = '$pro' ;");   
                                ...
                                <?php
                                    ...
                                    $s = mysqli_query($conexion, "SELECT SUM(g_montoBs) FROM gastos_constructora WHERE g_proyecto = '$pro' and contar = 'si' ;");   
                            ...
                            <div class="modal fade " id="exampleModali<?php echo $idp; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content  bg-opacity-80">
                                            <form action="eliminar_proyectos_constructora.php" method="post">
                            ...
                            <div class="modal fade " id="exampleModalp<?php echo $idp; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div style="background-color: #c7c5c6;" class="modal-content  bg-opacity-80">
                                            <form action="pdf_proyectos_constructora.php" method="post">
                                        <div class="modal-header">
