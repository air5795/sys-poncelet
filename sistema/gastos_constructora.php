<?php
    ...
    $query = mysqli_query($conexion, "SELECT * FROM gastos_constructora");
    ...
    if ($result > 0) {
        ...
        $sql_tfila = mysqli_query($conexion, "SELECT COUNT(id_gastoC) FROM gastos_constructora;");
    ...
    if (!empty($_POST)) {
       ...
       else 
     {
            ...
            $num = $total2 +1;
             ...
             if ($nombre_image != '') {
                 $destino = 'img/cajaChica_constructora_g/';
                 ...
                 $src= $destino.$imgActa;
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO gastos_constructora(
                        g_proyecto,
                        g_detalleGasto,
                        g_montoBs,
                        g_montoU,
        ...
        <div id="layoutSidenav_content">
                ...
                <h1 class="mt-4 col"><i class="fa-solid fa-cash-register"></i>  <strong>Registro  <span> CAJA CHICA PONCELET </strong><span style="color:#ff6363;"> Gastos  <i class="fa-solid fa-square-caret-down"></i></span></h1>
                       ...
                       <!-- contenido del sistema 2--> 
                        ...
                        <form action="gastos_constructora.php" method="post" class="fields was-validated " enctype="multipart/form-data" novalidate >
                        ...
                        ?>
                                    ...
                                    if ($result > 0) {
                                        while ($data = mysqli_fetch_array($query)) {
                                            if ($data['g_respaldo'] != 'nodisponible.png' ) {
                                                $image = 'img/cajaChica_constructora_g/'.$data['g_respaldo'];
                            ...
                            <div class="modal fade " id="exampleModal<?php echo $data['id_gastoC']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content  bg-opacity-80">
                                            <form action="editar_gastos_constructora.php" method="post">
                            ...
                            <div class="modal fade " id="exampleModali<?php echo $data['id_gastoC']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content  bg-opacity-80">
                                            <form action="eliminar_gastos_constructora.php" method="post">
                                        <div class="modal-header">
